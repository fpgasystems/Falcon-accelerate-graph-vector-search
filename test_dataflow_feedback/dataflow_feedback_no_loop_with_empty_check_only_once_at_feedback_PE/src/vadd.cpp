...
void PE_A(
	...
	// here, s_A_to_B does not seem to have any dependency with s_B_to_A,
	//   thus the compiler might think it can do concurrent scheduling, leading to deadlock? 
    // End by 
#if EMPTY_CHECK
...
void PE_B(
	...
	// no empty check if there is already dependency	
// #if EMPTY_CHECK
