...
int main(int argc, char** argv)
{
	...
	// if (sw_results_cnt == read_iter_per_query) {
	// 	std::cout << "No filtering in this setting... pass test" << std::endl;
	// 	return 0;
	// }
	...
	OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, int(runtime_n_buckets)));
